...
const Overview: FC<{ loading: boolean }> = ({ loading }) => {
  ...
  return (
    <Row gutter={[12, 12]}>
      <ColCard loading={loading} metaName={formatMessage({ id: 'app.dashboard.overview.totalSales' })} metaCount='¥ 126,560' body={<Trend wow='12%' dod='12%' />} footer={<Field name={formatMessage({ id: 'app.dashboard.overview.dailySales' })} number='￥12,423' />} />
      <ColCard loading={loading} metaName={formatMessage({ id: 'app.dashboard.overview.visits' })} metaCount='8846' body={<Line {...config} />} footer={<Field name={formatMessage({ id: 'app.dashboard.overview.dailySales' })} number='1234' />} />
      {/* <ColCard
        loading={loading}
