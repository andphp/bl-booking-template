...
type SysDepartmentModel struct { 
    ...
    DepartmentName  string       `form:"department_name" gorm:"column:department_name" json:"departmentName"` // 
    ParentID        int64        `form:"parent_id" gorm:"column:parent_id" json:"parentID"`                  // 
    DepartmentCode  string       `form:"department_code" gorm:"column:department_code" json:"departmentCode"` // 
    DepartmentType  int          `form:"department_type" gorm:"column:department_type" json:"departmentType"` // 部门类型：跨组织（区域）
}
...
var SysDepartmentColumn = struct {
    ID                   string
