...
type SysPositionModel struct { 
    ...
    PositionName  string       `form:"position_name" gorm:"column:position_name" json:"positionName"` // 职位名称
    DepartmentID  int64        `form:"department_id" gorm:"column:department_id" json:"departmentID"` // 部门ID
    PositionCode  string       `form:"position_code" gorm:"column:position_code" json:"positionCode"` // 部门编码
