...
type SysRoleModel struct { 
    ...
    RoleName           string       `form:"role_name" gorm:"column:role_name" json:"roleName"`                           // 角色名
    RoleNameEn         string       `form:"role_name_en" gorm:"column:role_name_en" json:"roleNameEn"`                   // 角色名_英文
    RoleParentID       string       `form:"role_parent_id" gorm:"column:role_parent_id" json:"roleParentID"`             // 父角色ID（父级包含子级角色权限）
    RoleDefaultPath    string       `form:"role_default_path" gorm:"column:role_default_path" json:"roleDefaultPath"`    // 默认菜单
    RoleRemark         string       `form:"role_remark" gorm:"column:role_remark" json:"roleRemark"`                     // 备注
    RoleAllParentID    string       `form:"role_all_parent_id" gorm:"column:role_all_parent_id" json:"roleAllParentID"`  // 所有上级id
    ...
    DeletedAt          *time.Time   `form:"deleted_at" gorm:"column:deleted_at" json:"deletedAt"`                        // 删除
