...
type SysAPIMenuRelationModel struct { 
    ...
    APIID         int64        `gorm:"column:api_id" json:"apiID"`               // 请求接口ID
    AbilityValue  string       `gorm:"column:ability_value" json:"abilityValue"` // 查询，添加，更新
    Path          string       `gorm:"column:path" json:"path"`                  // 接口路由
...
var ColumnSysAPIMenuRelation = struct {
    MenuID               string
	APIID                string
	AbilityValue         string
	Path                 string
